    ...
    oe_enclave_t* enclave)
{
    ...
    /* Add the TCS page */
    {
        ...
        /*
         * Since the addresses in tcs are expected to be from base by the sgx,
         * need to add an offset to base the tcs address values.
         */
    ...
    oe_enclave_t* enclave)
{
    ...
    if (enclave->simulate && context->create_zero_base_enclave)
    {
        OE_TRACE_WARNING(
            ...
            "which is currently not supported. Ignoring request to "
            "create 0-base enclave.\n");
        context->create_zero_base_enclave = 0;
